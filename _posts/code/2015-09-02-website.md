...
I am very happy about the state of web development today: oriented towards simplicity and portability and extensibility, modular code, near-standardized methodology, but most of all I love how MUCH code the community has put out!! I barely scratched the surface, but even then most of this website is composed of work by others.
...
- ...uses a bunch of other random services/widgets, like [Wufoo](http://www.wufoo.com/) for the contact form, [Disqus](https://disqus.com/home/) for comments, [FlickrIt](https://flickrit.com/) for producing Flickr galler slideshow widgets, and others I probably forgot to list.



#### I hope to eventually use:
...
The site's source can be found [on Github](https://github.com/Chocbanana/Chocbanana.github.io)
Happy browsing!! <3
